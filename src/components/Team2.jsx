...
const Team2 = () => {
  ...
  return (
    <div className="min-h-screen  from-purple-900 bg-green-800 via-gray-900 to-black flex items-center justify-center text-white">
      ...
      <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-8 rounded-2xl w-[90%] max-w-md shadow-2xl">
        ...
        <form onSubmit={handleAddTask} className="flex gap-2 mb-6">
          ...
          <button
            type="submit"
            className="bg-purple-500 hover:bg-purple-600 px-4 rounded-lg font-semibold"
          >
            Add
          </button>
